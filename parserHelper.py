...
#     path_attributes = []
#     for attr in m['path_attributes']:
#         path_attributes.append(bgp_attr_parser(attr, data)) # note this has side effects
#     data["path_attributes"] = path_attributes
#     return data


# def bgp_attr_parser(attr):
#     attrDict = {}

#     attr_t = list(attr['type'])[0]
#     attrDict["attribute_type"] = attr_t
    
#     if attr_t == BGP_ATTR_T['ORIGIN']:
#         attrDict["origin"] = ORIGIN_T[list(attr['value'])[0]]
#     elif attr_t == BGP_ATTR_T['NEXT_HOP']:
#         self.next_hop.append(attr['value'])
#     elif attr_t == BGP_ATTR_T['AS_PATH']:
#         self.as_path = []
